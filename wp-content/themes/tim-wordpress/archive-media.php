<?php
/**
 * Archive Template for Media Items
 * 
 * Displays a listing of all media items with hero section, grid layout, and pagination.
 * 
    ...
    <section class="relative min-h-[60vh] flex items-center justify-center py-20 md:py-32 overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <h1 class="font-serif text-4xl md:text-5xl lg:text-6xl text-[#faf8f5] mb-8 leading-tight">
                Featured Appearances and Media Coverage.
            </h1>

            <p class="text-[#faf8f5]/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Explore Joanna's media appearances, podcast interviews, and press coverage showcasing her expertise in authentic leadership and communication.
            </p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php else : ?>
                    <div class="col-span-full text-center py-20">
                        <p class="text-[#faf8f5]/60 text-lg">No media items found.</p>
                    </div>
                <?php endif; ?>
            </div>
