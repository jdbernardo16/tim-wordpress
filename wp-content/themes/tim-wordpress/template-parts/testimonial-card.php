...
<div class="bg-[#1a1a4e]/50 backdrop-blur-sm p-8 rounded-xl border border-[#faf8f5]/10 hover:border-[#d4952a]/30 transition-all duration-300 relative">
    <div class="absolute top-6 left-6 text-[#d4952a]/20">
    ...
    <div class="relative z-10">
        ...
        <div class="flex items-center gap-3">
            <img src="<?php echo esc_url($args['image']); ?>" alt="<?php echo esc_attr($args['author']); ?>" class="w-12 h-12 rounded-full object-cover border-2 border-[#d4952a]/30" />
            <div>
                <p class="text-[#d4952a] font-semibold"><?php echo esc_html($args['author']); ?></p>
