...
<section class="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-b from-[#1a1a4e]/70 via-[#1a1a4e]/80 to-[#1a1a4e]/90"></div>
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#232360]/50 to-[#1a1a4e]/90"></div>
    ...
    <div class="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
        <div class="mb-12">
            <div class="relative">
                <div class="absolute inset-0 bg-[#d4952a] blur-[60px] opacity-10 rounded-full animate-pulse"></div>
                <img
        ...
        <h1 class="text-[#d4952a] text-2xl md:text-4xl font-medium tracking-[0.2em] uppercase mb-4 relative">
            <span class="absolute -left-8 top-1/2 -translate-y-1/2 w-6 h-px bg-[#d4952a]/40 hidden md:block"></span>
            True Influence Method™️ — Joanna Horton McPherson
            <span class="absolute -right-8 top-1/2 -translate-y-1/2 w-6 h-px bg-[#d4952a]/40 hidden md:block"></span>
        </h1>

        <p class="text-[#faf8f5] font-serif italic text-xl md:text-3xl mb-8 font-light relative inline-block">
            <span class="absolute -top-3 -left-4 text-[#d4952a]/20 text-5xl font-serif">"</span>
            Your Voice Is Your Leadership.
            <span class="absolute -bottom-3 -right-4 text-[#d4952a]/20 text-5xl font-serif">"</span>
        </p>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="<?php echo esc_url(home_url('/apply')); ?>" class="group px-8 py-4 bg-[#d4952a] hover:bg-[#e8a838] text-[#1a1a4e] font-semibold rounded-lg transition-all hover:shadow-lg hover:shadow-[#d4952a]/20 text-center relative overflow-hidden">
            ...
            <a href="<?php echo esc_url(home_url('/programs')); ?>" class="px-8 py-4 border-2 border-[#d4952a] text-[#d4952a] hover:bg-[#d4952a]/10 font-semibold rounded-lg transition-all text-center">
                Explore Programs →
            </a>
        </div>
    </div>
    ...
    <div class="absolute bottom-12 left-1/2 transform -translate-x-1/2">
        <div class="animate-bounce">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#d4952a] opacity-60">
