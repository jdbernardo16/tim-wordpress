...
<a href="<?php the_permalink(); ?>" class="group bg-[#1a1a4e]/50 backdrop-blur-sm rounded-xl border border-[#faf8f5]/10 hover:border-[#d4952a]/30 transition-all duration-300 overflow-hidden !no-underline">
    ...
    <div class="p-6">
        ...
        <h3 class="font-serif text-xl text-[#faf8f5] mb-3 leading-tight group-hover:text-[#d4952a] transition-colors">
            <?php the_title(); ?>
        </h3>
        ...
        <div class="mt-4 flex items-center gap-2 text-[#d4952a] text-sm font-medium group-hover:gap-3 transition-all">
            Read More
