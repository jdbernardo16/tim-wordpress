...
<section class="relative min-h-screen flex items-center py-20 overflow-hidden bg-[#1a1a4e]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <!-- Text Content -->
            <div class="z-10">
                <span class="inline-block text-[#d4952a] font-semibold tracking-widest uppercase text-sm mb-4">
                    Leadership & Executive Coaching
                </span>

                <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-[#faf8f5]">
                    She Trains Leaders to <span class="italic text-[#d4952a]">Speak</span>.<br />
                    And Speakers to <span class="italic text-[#d4952a]">Lead</span>.
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-10">
                    <a
                        ...
                        class="inline-flex items-center justify-center px-8 py-4 bg-[#d4952a] text-[#1a1a4e] font-semibold rounded-full hover:bg-[#e8a838] transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Book Joanna to Speak
                    </a>
                    <a
                        href="#about"
                        class="inline-flex items-center justify-center px-8 py-4 border-2 border-[#faf8f5] text-[#faf8f5] font-semibold rounded-full hover:bg-[#faf8f5] hover:text-[#1a1a4e] transition-all duration-300">
                        Learn More
                        <!-- ArrowRight Icon -->
            ...
            <div class="relative h-[500px] lg:h-[700px] w-full rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-[#232360]/30 to-[#1a1a4e]/30">
                    <img
                    ...
                    <div class="absolute inset-0 bg-[#d4952a]/5 mix-blend-multiply"></div>
                </div>

                <!-- Decorative elements -->
                <div class="absolute bottom-8 left-8 bg-[#faf8f5]/90 backdrop-blur-sm p-6 rounded-xl max-w-xs shadow-lg hidden md:block">
                    <p class="font-serif italic text-[#1a1a4e] text-lg mb-2">
                        "True Influence"
                    </p>
                    <p class="text-xs text-[#1a1a4e]/70 uppercase tracking-wider font-semibold">
                        Signature Method
                    </p>
                </div>
            </div>
