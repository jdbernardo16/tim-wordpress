...
<div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#faf8f5]">
    <div class="w-14 h-14 bg-[#d4952a]/10 rounded-xl flex items-center justify-center mb-6">
        <?php echo $vault_icon; ?>
    </div>
    <h3 class="font-serif text-xl text-[#1a1a4e] mb-3">
        <?php echo esc_html($vault_title); ?>
    </h3>
    <p class="text-[#1a1a4e]/60 leading-relaxed">
