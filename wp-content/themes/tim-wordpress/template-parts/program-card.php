...
<div class="bg-[#1a1a4e] p-8 rounded-lg shadow-xl">
    <span class="text-[#d4952a] text-sm font-bold tracking-[0.1em] uppercase mb-4 block">
        <?php echo esc_html($program_level); ?>
    </span>
    <h4 class="font-serif text-2xl text-[#faf8f5] mb-4">
        <?php echo esc_html($program_title); ?>
    </h4>
    <p class="text-[#d4952a] text-lg font-medium mb-4">
