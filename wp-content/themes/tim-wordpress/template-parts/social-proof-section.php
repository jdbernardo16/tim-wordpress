...
<section class="py-20 bg-[#1a1a4e] relative overflow-hidden">
    <div class="absolute inset-0">
        <div class="absolute top-0 left-1/4 w-96 h-96 bg-[#d4952a]/5 rounded-full blur-[120px]"></div>
        <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-[#232360]/50 rounded-full blur-[120px]"></div>
    </div>

    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="text-center mb-12">
            <span class="inline-flex items-center gap-2 bg-[#d4952a]/10 border border-[#d4952a]/20 text-[#d4952a] text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full">
        ...
        <div class="mt-16 flex items-center justify-center gap-8 flex-wrap">
            <div class="text-center">
                <p class="text-4xl font-serif font-semibold text-[#d4952a] mb-1">100+</p>
            ...
            <div class="text-center">
                <p class="text-4xl font-serif font-semibold text-[#d4952a] mb-1">98%</p>
                <p class="text-[#faf8f5]/60 text-sm uppercase tracking-wider">Client Satisfaction</p>
            </div>
            <div class="w-px h-12 bg-[#faf8f5]/10 hidden md:block"></div>
            <div class="text-center">
                <p class="text-4xl font-serif font-semibold text-[#d4952a] mb-1">5+</p>
