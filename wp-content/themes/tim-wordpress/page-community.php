            ...
            <div class="grid md:grid-cols-2 gap-8 mt-16 max-w-4xl mx-auto">
                <a href="<?php echo home_url('/community/vault/'); ?>"
                   class="group relative bg-[#faf8f5]/5 backdrop-blur-sm border border-[#faf8f5]/10 rounded-2xl p-8 hover:border-[#d4952a]/50 transition-all duration-300">
                    <div class="absolute inset-0 bg-gradient-to-br from-[#d4952a]/10 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
