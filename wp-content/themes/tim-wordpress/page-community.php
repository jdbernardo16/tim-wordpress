            ...
            <div class="relative z-10 max-w-6xl mx-auto px-6 text-center">
                ...
                <div class="grid md:grid-cols-2 gap-8 mt-16 max-w-4xl mx-auto">
                    <a href="<?php echo home_url('/community/vault/'); ?>"
                        class="group relative bg-[#faf8f5]/5 backdrop-blur-sm border border-[#faf8f5]/10 rounded-2xl p-8 hover:border-[#d4952a]/50 transition-all duration-300">
                        <div class="absolute inset-0 bg-gradient-to-br from-[#d4952a]/10 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div class="relative z-10">
                            <div class="w-16 h-16 bg-[#d4952a]/20 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#d4952a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <h3 class="font-serif text-2xl text-[#faf8f5] mb-3 group-hover:text-[#d4952a] transition-colors">
                                The Vault
                            </h3>
        ...
        <section class="py-24 md:py-32 bg-[#faf8f5] text-[#1a1a4e] relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                <a href="<?php echo home_url('/apply/'); ?>"
                    class="inline-flex items-center gap-3 bg-[#d4952a] text-white text-sm uppercase tracking-widest px-8 py-4 rounded-full font-medium hover:bg-[#b37a1f] transition-colors duration-300 shadow-lg hover:shadow-xl">
