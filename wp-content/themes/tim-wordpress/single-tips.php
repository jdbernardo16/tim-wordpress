<?php
/**
 * Single Template for Tips
 * 
 * Displays a single tip with hero section, content, related posts, and CTA.
 * 
        ...
        <section class="relative min-h-[50vh] flex items-center justify-center py-20 md:py-32 overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
                <div class="mb-6 flex items-center justify-center gap-4 flex-wrap">
                    <a href="<?php echo get_post_type_archive_link('tips'); ?>" class="text-[#faf8f5]/60 hover:text-[#d4952a] transition-colors flex items-center gap-2 text-sm !no-underline">
