<?php
/**
 * Archive Template for Tips
 * 
 * Displays a listing of all tips with hero section, grid layout, and pagination.
 * 
    ...
    <section class="relative min-h-[60vh] flex items-center justify-center py-20 md:py-32 overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <p class="text-[#faf8f5]/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Quick, actionable tips and strategies you can implement immediately to enhance your communication and leadership presence.
            </p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php else : ?>
                    <div class="col-span-full text-center py-20">
                        <p class="text-[#faf8f5]/60 text-lg">No tips found.</p>
                    </div>
                <?php endif; ?>
            </div>
