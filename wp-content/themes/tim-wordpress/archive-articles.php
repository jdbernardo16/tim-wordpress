 ...
 * 
 * Displays a listing of all articles with hero section, grid layout, and pagination.
 * 
    ...
    <section class="relative min-h-[60vh] flex items-center justify-center py-20 md:py-32 overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <h1 class="font-serif text-4xl md:text-5xl lg:text-6xl text-[#faf8f5] mb-8 leading-tight">
                Leadership Begins With Knowing What You Stand For.
            </h1>

            <p class="text-[#faf8f5]/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Joanna writes about the intersection of leadership, communication, and authentic influence. Her articles explore the questions that matter most to founders, CEOs, and mission-driven leaders.
            </p>
        </div>
    </section>
