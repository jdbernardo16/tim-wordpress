...
<div class="overflow-x-hidden">
    <!-- Hero -->
    <section class="py-24 md:py-32 bg-[#1a1a4e]">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <span class="block text-[#d4952a] text-xs font-bold tracking-[0.2em] uppercase mb-6">
                Programs
            </span>
    ...
    <!-- Private Training -->
    <section class="py-24 md:py-32 bg-[#faf8f5] text-[#1a1a4e]">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-12">
                <span class="block text-[#d4952a] text-xs font-bold tracking-[0.2em] uppercase mb-6">
                    Flagship Offer · Private Clients
                </span>
                <h2 class="font-serif text-4xl md:text-5xl text-[#1a1a4e]">
                    Private Training: The Deepest Work Joanna Does.
                </h2>
            </div>
            <p class="text-[#1a1a4e]/80 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-12">
            ...
            <h3 class="font-serif text-2xl text-[#d4952a] mb-8 text-center">Three Levels of Private Training:</h3>
            ...
            <div class="bg-[#faf8f5]/50 p-8 rounded-lg max-w-3xl mx-auto mb-8">
                <h4 class="font-serif text-xl text-[#1a1a4e] mb-4">All private clients receive:</h4>
                <ul class="space-y-3">
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#d4952a] mr-3 mt-1 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"></polyline>
                        </svg>
                        <span class="text-[#1a1a4e]/80">Direct access to Joanna throughout engagement</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#d4952a] mr-3 mt-1 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"></polyline>
                        </svg>
                        <span class="text-[#1a1a4e]/80">Invitation to quarterly Mastermind & Retreat experiences</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#d4952a] mr-3 mt-1 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"></polyline>
                        </svg>
                        <span class="text-[#1a1a4e]/80">A lifetime messaging foundation they own completely</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#d4952a] mr-3 mt-1 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"></polyline>
                        </svg>
                        <span class="text-[#1a1a4e]/80">Access to The Vault — Joanna's members' resource library</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="text-center">
                <a href="<?php echo home_url('/apply/'); ?>"
                   class="inline-block px-8 py-4 bg-[#d4952a] hover:bg-[#e8a838] text-[#1a1a4e] font-semibold rounded-lg transition-all hover:shadow-lg hover:shadow-[#d4952a]/20">
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-12">
                <div class="bg-[#faf8f5]/5 p-6 rounded-lg">
                    <h4 class="font-serif text-lg text-[#d4952a] mb-2">What's Included:</h4>
                    <ul class="space-y-2 text-[#faf8f5]/80">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-[#d4952a] mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12"></polyline>
                            </svg>
                ...
                <div class="bg-[#d4952a]/10 p-6 rounded-lg flex flex-col justify-center items-center text-center">
                    <p class="text-[#d4952a] text-sm font-medium mb-2">Investment:</p>
                    <p class="text-[#d4952a] text-4xl font-serif mb-4">From $6,000</p>
                    <p class="text-[#faf8f5]/80 text-sm mb-6">90-Day Mastermind & Retreat</p>
                    <a href="<?php echo home_url('/apply/'); ?>"
                       class="inline-block px-6 py-3 bg-[#d4952a] hover:bg-[#e8a838] text-[#1a1a4e] font-semibold rounded-lg transition-all">
                        Join Speak & Rise →
                    </a>
                </div>
            </div>
    ...
    <section class="py-24 md:py-32 bg-[#faf8f5] text-[#1a1a4e]">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <h2 class="font-serif text-4xl md:text-5xl text-[#1a1a4e] mb-8">
            ...
            <!-- Corporate offerings -->
            <div class="grid md:grid-cols-2 gap-6 mb-12">
                <div class="bg-[#1a1a4e] p-6 rounded-lg">
                    <h4 class="font-serif text-lg text-[#d4952a] mb-4">Corporate offerings include:</h4>
                    <ul class="space-y-2 text-[#faf8f5]/80">
                        <li class="flex items-center">
                            <svg class="w-4 h-4 text-[#d4952a] mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12"></polyline>
                ...
                <div class="bg-[#1a1a4e] p-6 rounded-lg flex flex-col justify-center items-center text-center">
                    <p class="text-[#faf8f5]/80 text-lg mb-6">Investment:</p>
                    <p class="text-[#d4952a] text-4xl font-serif mb-2">Custom Pricing</p>
