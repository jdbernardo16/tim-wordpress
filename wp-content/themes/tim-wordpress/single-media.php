<?php
/**
 * Single Template for Media Items
 * 
 * Displays a single media item with hero section, content, related posts, and CTA.
 * 
    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <section class="relative min-h-[50vh] flex items-center justify-center py-20 md:py-32 overflow-hidden">
            <div class="absolute inset-0">
                ...
                <?php endif; ?>
                <div class="absolute inset-0 bg-gradient-to-b from-[#1a1a4e]/95 via-[#1a1a4e]/90 to-[#1a1a4e]" />
            </div>
            ...
            <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
                <div class="mb-6 flex items-center justify-center gap-4 flex-wrap">
                    <a href="<?php echo get_post_type_archive_link('media'); ?>" class="text-[#faf8f5]/60 hover:text-[#d4952a] transition-colors flex items-center gap-2 text-sm !no-underline">
